...
function filterDogOwners(arr) {
    let turiAugintini = arr.filter(turi => turi.hasDog)
    return turiAugintini

}
console.log(filterDogOwners(users))

function filterAdults(addults) {
    let yraPilnameciai = addults.filter(yra => yra.age >= 18)
    return yraPilnameciai
}
